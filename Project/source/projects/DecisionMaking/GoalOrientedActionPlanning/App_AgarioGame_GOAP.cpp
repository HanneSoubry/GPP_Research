...
App_AgarioGame_GOAP::App_AgarioGame_GOAP()
{
}
...
void App_AgarioGame_GOAP::Start()
{
	//Set Camera
...
void App_AgarioGame_GOAP::Update(float deltaTime)
{
	UpdateImGui();
...
void App_AgarioGame_GOAP::Render(float deltaTime) const
{
...
Blackboard* App_AgarioGame_GOAP::CreateBlackboard(AgarioAgent* a)
{
...
void App_AgarioGame_GOAP::UpdateImGui()
{
	//------- UI --------
